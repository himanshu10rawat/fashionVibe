    ...
    <div className="w-full">
      <div className="relative flex flex-col">
        <input
          ...
          className={`${adminForm && "order-2"} py-2 text-sm ${paddingX} text-gray-600 ${borderTop} ${borderLeft} ${borderRight} ${borderBottom} border-gray-300 ${focusBorderColor} outline-0 w-full ${rounded && "rounded-sm"} bg-white peer`}
