  ...
  return (
    <div className="flex gap-5">
      <div className="relative group">
        <div className="pb-5 inline relative overflow-hidden after:content-[''] after:absolute after:h-1 after:w-0 after:bg-orange-500 after:bottom-0 after:left-0 after:transition-all after:duration-200 group-hover:after:w-full">
          <User className="w-4 h-4 md:w-5 md:h-5 stroke-1 mx-auto" />
          <span className="text-xs md:text-sm inline-block">Profile</span>
        </div>
        <div className="p-5 w-80 absolute left-1/2 -translate-x-1/2 top-15.5 hidden  group-hover:block bg-white shadow-lg shadow-gray-300">
          <Link
